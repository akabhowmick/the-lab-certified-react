export const Booking = () => {
  return (
    <div>
      <div className="flex flex-col items-center border-b bg-white py-4 mb-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <a href="#" className="text-2xl font-bold text-gray-800">
          The Lab - Book a Class!
        </a>
      </div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          <p className="text-xl font-medium">Order Summary</p>
          <p className="text-black">Check your class date.</p>
        ...
        <div className="mt-10 mb-10 bg-gray-50 px-4 pt-8 lg:mt-0">
